...
<head>
	<title>(Mu)Sick | Admin Page</title>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <ul class="navbar-nav ml-auto align-items-center">
                <li class="nav-item">
                    <span style="font-size: 16px; color: blue; margin-right: 10px;"><?php echo "Logged in as ".$_SESSION['username'];?></span>
                    <span style="font-size: 16px; color: blue; margin-right: 10px;">| Admin Page |</span>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="logout.php"><b style="font-size: 16px;">Logout</b></a>
                </li>
            </ul>
        </nav>
    </div>
